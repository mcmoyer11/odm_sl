...
module OTLearn
  ...
  def OTLearn.set_uf_values(words, main_hypothesis)
    ...
    unset_features = find_unset_features(morpheme_list,main_hypothesis)
  ...
  # given word list, hypothesis, and list of conflicting features in the word
  ...
  def OTLearn.test_unset_feature(f_uf_instance, word_list, conflict_list, hypothesis)
    # Find the consistent values for the feature.
    consistent_values = OTLearn.consistent_feature_values(f_uf_instance,
      word_list, conflict_list, hypothesis)
  ...
  # with respect to the given word list, using the given hypothesis.
  ...
  def OTLearn.consistent_feature_values(f_uf_inst, word_list, conflict_features,
    ...
    f_uf_inst.feature.each_value do |test_val|
      ...
      consistent_combination_exists =
        eval_over_conflict_features(conflict_features, word_list, main_hypothesis)
  ...
  # Given: contrast_set, hypothesis, conflict_features
  ...
  def OTLearn.find_unset_features_in_words(word_list, main_hypothesis)
    ...
    return find_unset_features(morpheme_list,main_hypothesis)
  end

  # Returns a list of all the uf features in each of the morphemes in
  # the given list that are unset in the given hypothesis.
  def OTLearn.find_unset_features(morpheme_list,main_hypothesis)
    unset_features = []
  ...
  # feature within the given word list, relative to the given hypothesis.
  # Any new ranking information is added to the hypothesis.
  # Returns true if any new ranking information was obtained; false otherwise.
  def OTLearn.new_rank_info_from_feature(hypothesis, word_list, uf_feat_inst)
    ...
    return OTLearn::ranking_learning_mark_low(uo_conflict_words, hypothesis)
  end
