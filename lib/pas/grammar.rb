...
module PAS
  ...
  # A grammar for the PAS linguistic system consists of a reference to
  # the PAS::System linguistic system, a list of ERCs, and a lexicon.
  class Grammar
    ...
    # :call-seq:
    #   PAS::Grammar.new() -> PAS::Grammar
    #   PAS::Grammar.new(erc_list: mylist, lexicon: mylexicon) -> PAS::Grammar
    # 
    ...
    #--
    # The default linguistic system is PAS::System. The +system+ parameter is
