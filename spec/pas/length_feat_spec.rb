...
RSpec.describe PAS::Length_feat do
  context "A new Length_feat" do
    before(:each) do
      @length_feat = PAS::Length_feat.new
    end
    ...
    it "should accept SHORT as a valid value" do
      expect(@length_feat.valid_value?(PAS::Length_feat::SHORT)).to be true
    end
    it "should accept LONG as a valid value" do
      expect(@length_feat.valid_value?(PAS::Length_feat::LONG)).to be true
    end
