...
RSpec.describe SL::Stress_feat do
  context "A new Stress_feat" do
    ...
    it "should accept UNSTRESSED as a valid value" do
      expect(@stress_feat.valid_value?(SL::Stress_feat::UNSTRESSED)).to be true
    end
    it "should accept MAIN_STRESS as a valid value" do
      expect(@stress_feat.valid_value?(SL::Stress_feat::MAIN_STRESS)).to be true
    end
